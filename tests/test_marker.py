...
class TestMarker:
    ...
    def test_convert_pdf_to_markdown_success(self, mock_file, mock_tempdir, mock_subprocess):
        ...
        with patch('pathlib.Path.exists', return_value=True):
            result = convert_pdf_to_markdown('/path/to/test.pdf')
    ...
    @patch('rubot.marker.subprocess.run')
    @patch('rubot.marker.tempfile.TemporaryDirectory')
    def test_convert_pdf_to_markdown_subprocess_error(self, mock_tempdir, mock_subprocess):
    ...
    @patch('rubot.marker.subprocess.run')
    @patch('rubot.marker.tempfile.TemporaryDirectory')
    def test_convert_pdf_to_markdown_no_output_file(self, mock_tempdir, mock_subprocess):
